...
local function HeartbeatUpdate()
	...
	FpsLabel.Text = ("罐子时间:"..os.date("%H").."时"..os.date("%M").."分"..os.date("%S"))
end
...
local Window = OrionLib:MakeWindow({IntroText = "罐子脚本中心V1.0",Name = "罐子脚本中心", HidePremium = false, SaveConfig = true, ConfigFolder = ""})
...
WSBTab:AddParagraph("当前版本","V1.0最新版8月9日更新")
