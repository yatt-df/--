...
local Window = OrionLib:MakeWindow({IntroText = "罐子中心",Name = "罐子中心", HidePremium = false, SaveConfig = true, ConfigFolder = ""})
local about = Window:MakeTab({
    Name = "必看公告",
    Icon = "rbxassetid://4483345998",
    PremiumOnly = false
})
about:AddParagraph("脚本作者:TaMak1","")
about:AddParagraph("脚本永久免费","")
about:AddParagraph("作者是新人，虽然是缝合但是以后会多多自制，请理解","")
about:AddParagraph("圈钱人死全家","")
about:AddParagraph("刚出道，请勿骂","")
about:AddParagraph(" Q群:暂无","")
